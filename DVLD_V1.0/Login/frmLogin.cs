...
namespace DVLD_V1._0.Login
{
    public partial class frmLogin : Form
    {
        ...
        {
            clsUser user = clsUser.FindByUsernameAndPassword(txtUserName.Text.Trim(),clsPaswordSecurity.ComputeHashing(txtPassword.Text.Trim()));

            if (user != null)
            {
                string HashedPaasword = clsPaswordSecurity.ComputeHashing(txtPassword.Text.Trim());
