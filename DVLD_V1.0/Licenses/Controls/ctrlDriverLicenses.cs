using DVLD_Buisness;
using DVLD_V1._0.Licenses.Local_Licenses;
using System;
...
namespace DVLD_V1._0.Licenses.Controls
{
    public partial class ctrlDriverLicenses : UserControl
    {
        ...
        private void InternationalLicenseHistorytoolStripMenuItem_Click(object sender, EventArgs e)
        {
           ...
           Licenses.International_Licenses.frmShowInternationalLicenseInfo frm = new Licenses.International_Licenses.frmShowInternationalLicenseInfo(InternationalLicenseID);
            frm.ShowDialog();
        }
    }
}
